    ...
    <>
      <header className=" h-1/6 w-full min-h-24 bg-[#8e8d8a]   ">
        <ol className="h-full w-full  bg-[#8e8d8a] text-[#f8d6a6]  font-semibold mb-2 capitalize flex items-center justify-between min-h-24 ">
          ...
          <li className="header2 min-h-max shadow-lg shadow-[#15152c5b] h-1/2 w-1/12 p-1 flex flex-col items-center text-center justify-center  ">
            {" "}
          ...
          <li
            className="header3 h-1/2 w-1/12 p-1 flex items-center text-center justify-center shadow-lg shadow-[#15152c5b]"
